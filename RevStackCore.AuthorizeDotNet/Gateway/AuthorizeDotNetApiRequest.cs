...
namespace RevStackCore.AuthorizeDotNet.Gateway
{
    public class AuthorizeDotNetApiRequest 
    {
        public IGatewayResponse Send(AuthorizeDotNetRequest request)
        {
            ...
            {
                response = Task.Run(() => SendHttpChargeRequest(request)).Result;
            }
        ...
        private async Task<IGatewayResponse> SendHttpChargeRequest(AuthorizeDotNetRequest request) 
        {
            //validate the inputs
            request.Validate();
            ...
            //var myWriter = new StreamWriter(await webRequest.GetRequestStreamAsync());
        ...
        //    using (var webService = new RevStackCore.AuthorizeDotNet.net.authorize.api.Service())
        //    {
        //        //webService.Url = request.PostUrl;
        //        GetUnsettledTransactionListRequestType listType = new GetUnsettledTransactionListRequestType();
        //        GetUnsettledTransactionListResponseType response = webService.GetUnsettledTransactionListAsync(authentication, listType, null);
